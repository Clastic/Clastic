module.exports = function() {
    'use strict';
    return [
        new global.Clastic.GulpScript('web/vendor/jquery/dist/jquery.js', 'vendor', {weight: 0}),
        new global.Clastic.GulpScript('web/vendor/bootstrap/dist/js/bootstrap.js', 'vendor', {weight: 0}),
        new global.Clastic.GulpScript('web/vendor/mousetrap/mousetrap.js', 'vendor', {weight: 10}),
        ...
        new global.Clastic.GulpScript('web/vendor/ckeditor/ckeditor.js', 'vendor', {weight: 10}),
